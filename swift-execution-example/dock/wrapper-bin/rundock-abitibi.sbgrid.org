...
dockpack=/se/data/vo/osg/houzx/dockKAGxNL.tar.gz
# Dock app version
dock6app=/se/app/vo/osg/houzx/work-pac/dock6/bin/dock6       # for test at hpc.ufl 
loadfile()
{
    DIR_RAM="$1"
    ARCHIVE="$2"
...
echo "abitibi.sbgrid.org,$ligfile"
