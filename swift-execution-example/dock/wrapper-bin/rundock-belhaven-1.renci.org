...
dockpack=/nfs/osg-data/osg/houzx/dockKAGxNL.tar.gz
# Dock app version
dock6app=/nfs/osg-app/osg/houzx/work-pac/dock6/bin/dock6       # for test at hpc.ufl 
loadfile()
{
    DIR_RAM="$1"
    ARCHIVE="$2"
...
echo "belhaven-1.renci.org,$ligfile"
