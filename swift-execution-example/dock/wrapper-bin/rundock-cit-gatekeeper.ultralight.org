...
userdir=/tmp
dock=$userdir/dock
#dockpack=/home/ligandatlas/packages/dockKAGxNL.tar.gz
dockpack=/raid2/osg-data/osg/houzx/dockKAGxNL.tar.gz
# Dock app version
dock6app=/raid1/osg-app/osg/houzx/work-pac/dock6/bin/dock6       # for test at hpc.ufl 
loadfile()
{
    DIR_RAM="$1"
    ARCHIVE="$2"
...
echo "cit-gatekeeper.ultralight.org,$ligfile"
